Airplay Free (Forked from Remote Speakers Output Plug-In)

Copyright (c) 2006-2021  Eric Milles
Forked by [Your Name/Organization]
...
4) For foobar2000: Copy foo_apx.dll from plug-in install directory to player's
   ...
   plug-in (https://kerlilow.me/files/downloads/MusicBeeIPC.zip) is recommended;
